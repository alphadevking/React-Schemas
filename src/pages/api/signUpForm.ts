...
export default function handler(req: NextApiRequest, res: NextApiResponse<FormResponse>) {
    ...
    if (req.method === 'POST') {
        ...
        const newFormEntry: FormEntry = { firstname, lastname, email, password };

        console.log('Received new form entry:', newFormEntry);
